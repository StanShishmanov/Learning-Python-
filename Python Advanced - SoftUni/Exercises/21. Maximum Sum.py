def read_matrix(cell_delimiter):
    (rows_count, columns_count) = input().split(cell_delimiter)
    return [list(map(int, input().split(cell_delimiter))) for _ in range(int(rows_count))]
